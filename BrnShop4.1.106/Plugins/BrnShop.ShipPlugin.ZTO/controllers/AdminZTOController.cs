...
namespace BrnShop.Web.Admin.Controllers
{
    ...
    /// 后台中通快递控制器类
    /// </summary>
    public class AdminZTOController : BaseAdminController
    {
        /// <summary>
        /// 配送规则列表
        /// </summary>
        ...
        public ActionResult ShipRuleList()
        {
            ...
            return View("~/plugins/BrnShop.ShipPlugin.ZTO/views/adminzto/shiprulelist.cshtml", model);
        }
        ...
        public ActionResult AddShipRule()
        {
            ...
            Load(-1, -1, -1);
            return View("~/plugins/BrnShop.ShipPlugin.ZTO/views/adminzto/addshiprule.cshtml", model);
        }
        ...
        public ActionResult AddShipRule(ShipRuleModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                AddAdminOperateLog("添加中通快递配送规则");
                return PromptView(Url.Action("config", "plugin", new { configController = "AdminZTO", configAction = "ShipRuleList" }), "配送规则添加成功");
            }

            return PromptView(Url.Action("config", "plugin", new { configController = "AdminZTO", configAction = "AddShipRule" }), "内容有误，请重写填写");
        }
        ...
        public ActionResult EditShipRule(string shipRuleName = "")
        {
            ...
            if (shipRuleInfo == null)
                return PromptView(Url.Action("config", "plugin", new { configController = "AdminZTO", configAction = "ShipRuleList" }), "配送规则不存在");
            ...
            return View("~/plugins/BrnShop.ShipPlugin.ZTO/views/adminzto/editshiprule.cshtml", model);
        }
        ...
        public ActionResult EditShipRule(ShipRuleModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                AddAdminOperateLog("编辑中通快递配送规则");
                return PromptView(Url.Action("config", "plugin", new { configController = "AdminZTO", configAction = "ShipRuleList" }), "配送规则编辑成功");
            }

            return PromptView(Url.Action("config", "plugin", new { configController = "AdminZTO", configAction = "EditShipRule", shipRuleName = shipRuleInfo.Name }), "内容有误，请重写填写");
        }
        ...
        public ActionResult DelShipRule(string shipRuleName = "")
        {
            ...
            PluginUtils.SaveShipRuleList(shipRuleList);
            AddAdminOperateLog("删除中通快递配送规则");
            return PromptView(Url.Action("config", "plugin", new { configController = "AdminZTO", configAction = "ShipRuleList" }), "配送规则删除成功");
        }
    }
}
