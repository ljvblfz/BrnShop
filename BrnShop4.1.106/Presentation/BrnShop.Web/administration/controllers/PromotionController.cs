...
namespace BrnShop.Web.Admin.Controllers
{
    ...
    public partial class PromotionController : BaseAdminController
    {
        ...
        public ActionResult SinglePromotionList(string productName, string promotionName, string promotionTime, int pid = -1, int pageSize = 15, int pageNumber = 1)
        {
            ...
            ShopUtils.SetAdminRefererCookie(string.Format("{0}?pageNumber={1}&pageSize={2}&pid={3}&productName={4}&promotionName={5}&promotionTime={6}",
        ...
        public ActionResult BuySendPromotionList(string promotionName, string promotionTime, int pageSize = 15, int pageNumber = 1)
        {
            ...
            ShopUtils.SetAdminRefererCookie(string.Format("{0}?pageNumber={1}&pageSize={2}&promotionName={3}&promotionTime={4}",
