...
var categorySelectLayerHtml = "<div class='selectBoxProgressBar'><p><img src='/administration/images/progressbar.gif'/></p></div>";
...
var brandSelectLayerHtml = "<div class='selectBoxProgressBar'><p><img src='/administration/images/progressbar.gif'/></p></div>";
...
function ajaxBrandSelectList(brandName, pageNumber) {
    ...
    $.get("/admin/brand/selectlist?t=" + new Date(), {
        ...
        var html = "<div id='selectBrandBox'><table width='100%' ><tr><td>品牌名称：<input type='text' id='searchBrandOfSelectList'  name='searchBrandOfSelectList' style='width:120px;height:18px;'> <input type='image' onclick='searchBrandSelectList()' src='/administration/images/s.jpg' class='searchBut'></td></tr><tr><td><div id='selectBrandBoxCon'><ul>";
...
var productSelectLayerHtml = "<div class='selectBoxProgressBar'><p><img src='/administration/images/progressbar.gif'/></p></div>";
...
function ajaxProductSelectList(productName, pageNumber) {
    ...
    $.get("/admin/product/productselectlist?t=" + new Date(), {
        ...
        var listObj = eval("(" + data + ")");
        var html = "<div id='selectProductBox'><table width='100%' ><tr><td>商品名称：<input type='text' id='searchProductOfSelectList'  name='searchProductOfSelectList' style='width:120px;height:18px;'> <input type='image' onclick='searchProductSelectList()' src='/administration/images/s.jpg' class='searchBut'></td></tr><tr><td><div id='selectProductBoxCon'><ul>";
        for (var i = 0; i < listObj.items.length; i++) {
