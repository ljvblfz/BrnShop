...
namespace BrnShop.Services
{
    ...
    public partial class AdminPromotions : Promotions
    {
        ...
        {
            return BrnShop.Data.Promotions.AdminGetSinglePromotionList(pageSize, pageNumber, condition);
        }
        ...
        {
            return BrnShop.Data.Promotions.AdminGetBuySendPromotionList(pageSize, pageNumber, condition);
        }
        ...
        {
            return BrnShop.Data.Promotions.AdminGetGiftPromotionList(pageSize, pageNumber, condition);
        }
        ...
        {
            return BrnShop.Data.Promotions.AdminGetSuitPromotionList(pageSize, pageNumber, condition);
        }
        ...
        {
            return BrnShop.Data.Promotions.AdminGetFullSendPromotionList(pageSize, pageNumber, condition);
        }
        ...
        {
            return BrnShop.Data.Promotions.AdminGetFullCutPromotionList(pageSize, pageNumber, condition);
        }
