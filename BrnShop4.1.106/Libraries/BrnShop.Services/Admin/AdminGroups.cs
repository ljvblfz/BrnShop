    ...
    public partial class AdminGroups
    {
        ...
        private static void WriteAdminNavMenuCache(AdminGroupInfo adminGroupInfo)
        {
            ...
            if (adminGroupActionHashSet.Contains("order"))
            {
                ...
                menu.AppendFormat("{0}\"title\":\"售后服务\",\"url\":\"/admin/order/afterservicelist\"{1},", "{", "}");
            ...
            if (adminGroupActionHashSet.Contains("stat"))
            {
                ...
                menu.AppendFormat("{0}\"title\":\"销售明细\",\"url\":\"/admin/stat/saleproductlist\"{1},", "{", "}");
                menu.AppendFormat("{0}\"title\":\"订单统计\",\"url\":\"/admin/stat/orderstat\"{1},", "{", "}");
            ...
            if (adminGroupActionHashSet.Contains("set"))
            {
            ...
            if (adminGroupActionHashSet.Contains("shipcompany"))
            {
                menu.AppendFormat("{0}\"title\":\"配送公司\",\"url\":\"/admin/shipcompany/list\"{1},", "{", "}");
                flag = true;
            }
