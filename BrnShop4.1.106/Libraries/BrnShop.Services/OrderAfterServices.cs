...
namespace BrnShop.Services
{
    ...
    public partial class OrderAfterServices
    {
        ...
        public static void ApplyOrderAfterService(OrderProductInfo orderProductInfo, int count, int type, string applyReason)
        {
            ...
            ApplyOrderAfterService(orderProductInfo.Uid, orderProductInfo.Oid, orderProductInfo.RecordId, orderProductInfo.Pid, orderProductInfo.CateId, orderProductInfo.BrandId, orderProductInfo.Name, orderProductInfo.ShowImg, count, money, type, applyReason, DateTime.Now);
        }
        ...
        public static void ApplyOrderAfterService(int uid, int oid, int recordId, int pid, int cateId, int brandId, string pname, string pshowImg, int count, decimal money, int type, string applyReason, DateTime applyTime)
        {
            BrnShop.Data.OrderAfterServices.ApplyOrderAfterService(OrderAfterServiceState.Checking, uid, oid, recordId, pid, cateId, brandId, pname, pshowImg, count, money, type, applyReason, applyTime);
        }
        ...
        {
            BrnShop.Data.OrderAfterServices.SendOrderAfterService(asId, OrderAfterServiceState.Sended, shipCoId, shipCoName, shipSN, regionId, consignee, mobile, phone, email, zipCode, address, sendTime);
        }
        ...
        {
            BrnShop.Data.OrderAfterServices.CompleteOrderAfterService(asId, OrderAfterServiceState.Completed);
        }
        ...
        {
            return BrnShop.Data.OrderAfterServices.GetOrderAfterServiceList(oid);
        }
        ...
        {
            return BrnShop.Data.OrderAfterServices.GetOrderProductAfterServiceList(recordId);
        }
        ...
        {
            return BrnShop.Data.OrderAfterServices.GetOrderAfterServiceByASId(asId);
        }
    }
}
