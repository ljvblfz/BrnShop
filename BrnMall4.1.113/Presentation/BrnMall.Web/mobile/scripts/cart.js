...
function getFullSendResponse(data) {
    ...
    if (result.state != "success") {
        ...
        for (var i = 0; i < result.content.length; i++) {
            ...
            html += "<a href='" + result.content[i].url + "' class='proImg'><img src='/upload/store/" + result.content[i].storeId + "/product/show/thumb60_60/" + result.content[i].showImg + "' width='59' height='59' /></a>";
            html += "<div class='text'>";
