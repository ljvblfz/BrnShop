    ...
    public partial class OAuths
    {
        ...
        public static UserInfo CreateOAuthUser(string oUserName, string uNamePrefix, string openId, string server, int regionId)
        {
            ...
            if (uid > 0)
            {
                ...
                BrnMall.Data.OAuths.CreateOAuthUser(oauthInfo);
            }
            else
            {
                userInfo = null;
        ...
        {
            return BrnMall.Data.OAuths.GetOAuthUserByUid(uid);
        }
        ...
        {
            return BrnMall.Data.OAuths.GetOAuthUserList(CommonHelper.IntArrayToString(uidList));
        }
